...
export const ACCENTS: AccentDef[] = [
  {
    ...
    primaryGlow: "oklch(0.78 0.18 155)",
    ring: "oklch(0.62 0.16 155 / 60%)",
    themeColor: "#0B8F4D",
  },
  {
    id: "blue",
    ...
    primaryGlow: "oklch(0.78 0.17 250)",
    ring: "oklch(0.62 0.17 250 / 60%)",
    themeColor: "#2563EB",
  },
  {
    id: "purple",
    ...
    primaryGlow: "oklch(0.76 0.20 300)",
    ring: "oklch(0.60 0.20 300 / 60%)",
    themeColor: "#7C3AED",
  },
  {
    id: "orange",
    ...
    primaryGlow: "oklch(0.82 0.18 50)",
    ring: "oklch(0.70 0.18 50 / 60%)",
    themeColor: "#EA580C",
  },
  {
    id: "gold",
    ...
    primaryGlow: "oklch(0.88 0.16 90)",
    ring: "oklch(0.78 0.16 90 / 60%)",
    themeColor: "#CA8A04",
  },
  {
    id: "red",
    ...
    primaryGlow: "oklch(0.78 0.22 27)",
    ring: "oklch(0.62 0.22 27 / 60%)",
    themeColor: "#DC2626",
  },
  {
    id: "pink",
    ...
    primaryGlow: "oklch(0.82 0.20 350)",
    ring: "oklch(0.68 0.20 350 / 60%)",
    themeColor: "#DB2777",
  },
  {
    id: "cyan",
    label: "Aqua Cyan",
    swatch: "#06B6D4",
    primary: "oklch(0.70 0.13 210)",
    primaryGlow: "oklch(0.84 0.13 210)",
    ring: "oklch(0.70 0.13 210 / 60%)",
    themeColor: "#0891B2",
  },
  {
    id: "indigo",
    ...
    primaryGlow: "oklch(0.74 0.18 275)",
    ring: "oklch(0.58 0.18 275 / 60%)",
    themeColor: "#4F46E5",
  },
  {
    id: "emerald",
    label: "Fresh Emerald",
    swatch: "#10B981",
    primary: "oklch(0.68 0.16 165)",
    primaryGlow: "oklch(0.82 0.16 165)",
    ring: "oklch(0.68 0.16 165 / 60%)",
    themeColor: "#059669",
  },
  {
    id: "yellow",
    ...
    primaryGlow: "oklch(0.94 0.14 95)",
    ring: "oklch(0.86 0.17 95 / 60%)",
    themeColor: "#EAB308",
  },
  {
    id: "white",
    ...
    primaryGlow: "oklch(0.99 0 0)",
    ring: "oklch(0.97 0 0 / 60%)",
    themeColor: "#F1F5F9",
  },
  {
    id: "black",
    ...
    primaryGlow: "oklch(0.35 0.03 260)",
    ring: "oklch(0.22 0.02 260 / 60%)",
    themeColor: "#0F172A",
  },
];
...
export function AccentColorProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const stored =
      (typeof window !== "undefined" && (localStorage.getItem(STORAGE_KEY) as AccentId | null)) ||
      "default";
