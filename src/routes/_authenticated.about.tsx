...
export const Route = createFileRoute("/_authenticated/about")({
  head: () =>
    pageHead({
      ...
      description:
        "Learn how Nova Vision AI blends multimodal vision, real-time reasoning, and a clean interface to help you understand the world through your camera.",
    }),
  component: AboutPage,
});
...
const FEATURES = [
  {
    ...
    desc: "Identify plants, food, products, and objects instantly.",
  },
    ...
    <PageShell>
        ...
        {[
          {
            icon: Target,
            title: "Our Mission",
            body: "Make AI vision accessible, accurate, and helpful for everyone — every day.",
            color: "from-emerald-500 to-green-600",
          },
          {
            icon: Eye,
            title: "Our Vision",
            body: "A world where understanding any object is just one tap away.",
          ...
          >
            <div
              className={`size-10 rounded-2xl bg-gradient-to-br ${c.color} grid place-items-center mb-2 shadow-lg`}
            >
      ...
      >
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Reach our team via Contact Support in the sidebar.
        </p>
        <p className="text-[11px] text-muted-foreground mt-3">
          Built with care by the Nova Vision AI team.
        </p>
      </motion.div>
    </PageShell>
  );
