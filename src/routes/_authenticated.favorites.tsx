...
function FavoritesPage() {
  ...
  async function share(r: Row) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({ text, title: r.title });
      } catch {
        /* */
      }
    } else {
      ...
      {rows === null ? (
        ...
        <div className="glass-card p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Tap the heart on any scan to save it here.
          </p>
        </div>
      ) : (
            ...
            <div key={r.id} className="glass-card overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="flex justify-between mt-2">
                  <button onClick={() => share(r)} className="p-1.5 rounded-lg hover:bg-accent">
